...
class SawAudio extends SpriteAnimationComponent with HasGameRef<PixelAdventure>, CollisionCallbacks{
  double volume;
  bool sawAudioState = false;
  ...
  void onCollisionStart(Set<Vector2> intersectionPoints, PositionComponent other) async{
    if(other is Player){
      if(game.playAudio && !sawAudioState){

        FlameAudio.play("saw.mp3");
        sawAudioState = true;
      }else{
